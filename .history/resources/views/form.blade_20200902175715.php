                            ...
                            <div class="col-md-10 center-form border-box" style="margin-top: 20px;padding-bottom: 100px;">
                                <form method="post" class="contact-form" id="FormOne" enctype="multipart/form-data">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="col-md-6">
                                            <input id="non_refree1_workplace" class="Subject" type="text" name="non_refree1_workplace" placeholder="Non-Related Referee1 Workplace /නිර්දේශ කරන්නාගේ රැකියා s 1" >
                                        </div>
