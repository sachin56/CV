                        ...
                        <div class="row">
                            ...
                            <div class="col-md-10 center-form border-box" style="margin-top: 20px;padding-bottom: 100px;">
                                <form method="post" class="contact-form" id="FormFive" enctype="multipart/form-data">
                                    ...
                                    <div class="col-md-12">
                                        <input id="fullname" class="contact-f-name" type="text" name="full_name" placeholder="Full Name" required>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <input id="contact1" class="address3" type="text" name="contact1" placeholder="Contact No 1" required>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <input id="email" class="contact-email" type="email" name="email" placeholder="Email" required>
                                    </div>

                                    <div class="col-md-12">
                                        <input id="objective" class="contact-Enter Details" type="text" name="objective" placeholder="Careere Objective" required>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <input id="Results" class="non_refree1_name" type="text" name="non_refree1_name" placeholder="Non-Related Refree1 Name " required>
                                    </div>

                                    <div class="col-md-6">
                                        <input id="Results" class="non_refree1_post" type="text" name="non_refree1_post" placeholder="Non-Related Refree1 Post" required>
                                    </div>

                                    <div class="col-md-6">
                                        <input id="Results" class="non_refree1_workplace" type="text" name="non_refree1_workplace" placeholder="Non-Related Refree1 Workplace " required>
                                    </div>

                                    <div class="col-md-6">
                                        <input id="Results" class="non_refree1_tel" type="text" name="non_refree1_tel" placeholder="Non-Related Refree1 Tel " required>
                                    </div>
