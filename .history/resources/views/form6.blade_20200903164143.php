                        ...
                        <div class="row">
                            ...
                            <div class="col-md-10 center-form border-box" style="margin-top: 20px;padding-bottom: 100px;">
                                <form method="post" class="contact-form" id="FormSix" enctype="multipart/form-data">
                                    ...
                                    <div class="col-md-12">
                                        <input id="contact-f-name" class="contact-f-name" type="text" name="full_name" placeholder="Full Name" >
                                    </div>

                                    <div class="col-md-12">
                                        <input id="contact-email" class="contact-email" type="email" name="email" placeholder="Email" >
                                    </div>

                                    <div class="col-md-6">
                                        <input id="address3" class="address3" type="text" name="contact1" placeholder="Contact No 1" >
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <input id="fullname" class="fname" type="text" name="p_name" placeholder="Full Name" >
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <input id="dofb" class="dofb" type="text" name="p_dob" placeholder="Date of Birth" >
                                    </div>
