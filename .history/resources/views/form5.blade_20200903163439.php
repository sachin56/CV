                        ...
                        <div class="row">
                            ...
                            <div class="col-md-10 center-form border-box" style="margin-top: 20px;padding-bottom: 100px;">
                                <form method="post" class="contact-form" id="FormFive" enctype="multipart/form-data">
                                    ...
                                    <div class="col-md-12">
                                        <input id="objective" class="contact-Enter Details" type="text" name="objective" placeholder="Careere Objective" >
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <input id="contact-Qulification One" class="contact-Qulification One" type="text" name="a_qualify1" placeholder="Qulification One" >
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <input id="contact-Enter Details" class="contact-Enter Details" type="text" name="skill_ability" placeholder="Enter Details" >
                                    </div>
                                    <div class="col-md-12">
                                    ...
                                    <div class="col-md-6">
                                        <input id="Subject" class="Subject" type="text" name="subject1" placeholder="Subject1" >
                                    </div>

                                    <div class="col-md-6">
                                        <input id="Results" class="Results" type="text" name="results1" placeholder="Results1" >
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <input id="Results" class="Results" type="text" name="ol_subject1" placeholder="Subject 1" >
                                    </div>
                                    <div class="col-md-6">
                                        <input id="Results" class="Results" type="text" name="ol_result1" placeholder="Results 1" >
                                    </div>

                                    <div class="col-md-6">
                                        <input id="Results" class="Results" type="text" name="ol_subject2" placeholder="Subject 2" >
                                    </div>
                                    <div class="col-md-6">
                                        <input id="Results" class="Results" type="text" name="ol_result2" placeholder="Results 2" >
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <input id="Results" class="Results" type="text" name="al_subject1" placeholder="Subject " >
                                    </div>
                                    <div class="col-md-6">
                                        <input id="Results" class="Results" type="text" name="al_result1" placeholder="Results " >
                                    </div>
                                    <div class="col-md-6">
                                        <input id="Results" class="Results" type="text" name="al_subject2" placeholder="Subject " >
                                    </div>
                                    <div class="col-md-6">
                                        <input id="Results" class="Results" type="text" name="al_result2" placeholder="Results " >
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <input id="Results" class="Results" type="text" name="lead1" placeholder="Leaderships 1" >
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <input id="Results" class="Results" type="text" name="game1" placeholder="Games And Athletics 1" >
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <input id="Results" class="Results" type="text" name="skill1" placeholder="Skills And Competencies: 1" >
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <input id="Results" class="Results" type="text" name="dob" placeholder="Date of Birth" >
                                    </div>
                                    <div class="col-md-6">
                                        <input id="Results" class="Results" type="text" name="m_status" placeholder="Martial Status" >
                                    </div>

                                    <div class="col-md-6">
                                        <input id="Results" class="Results" type="text" name="nationality" placeholder="Nationality" >
                                    </div>
                                    <div class="col-md-6">
                                        <input id="Results" class="Results" type="text" name="nic" placeholder="NIC" >
                                    </div>

                                    <div class="col-md-6">
                                        <input id="Results" class="Results" type="text" name="school" placeholder="School Attended" >
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <input id="non_refree1_name" class="non_refree1_name" type="text" name="non_refree1_name" placeholder="Non-Related Refree1 Name " >
                                    </div>

                                    <div class="col-md-6">
                                        <input id="non_refree1_post" class="non_refree1_post" type="text" name="non_refree1_post" placeholder="Non-Related Refree1 Post" >
                                    </div>

                                    <div class="col-md-6">
                                        <input id="non_refree1_workplace" class="non_refree1_workplace" type="text" name="non_refree1_workplace" placeholder="Non-Related Refree1 Workplace " >
                                    </div>

                                    <div class="col-md-6">
                                        <input id="non_refree1_tel" class="non_refree1_tel" type="text" name="non_refree1_tel" placeholder="Non-Related Refree1 Tel " >
                                    </div>
