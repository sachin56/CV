                            ...
                            <div class="col-md-10 center-form border-box" style="margin-top: 20px;padding-bottom: 100px;">
                                <form method="post" class="contact-form" id="FormOne" enctype="multipart/form-data">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="col-md-6">
                                            <input id="Subject" class="Subject" type="text" name="non_refree2_name" placeholder="Referee2 Name" >
                                        </div>

                                        <div class="col-md-6">
                                            <input id="Subject" class="Subject" type="text" name="non_refree2_post" placeholder="Non-Related Referee2 Post" >
                                        </div>

                                        <div class="col-md-6">
                                            <input id="Subject" class="Subject" type="text" name="non_refree2_workplace" placeholder="Non-Related Referee2 Workplace" >
                                        </div>
