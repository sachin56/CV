                        ...
                        <div class="row">
                            ...
                            <div class="col-md-10 center-form border-box" style="margin-top: 20px;padding-bottom: 100px;">
                                <form method="post" class="contact-form" id="FormOne" enctype="multipart/form-data">
                                    ...
                                    <div class="col-md-12">
                                        <input id="Subject" class="Subject" type="text" name="a_qualify3" placeholder="Acedemic Qualifications 3 / අධ්‍යාපනික සුදුසුකම් 1">
                                    </div>

                                    <div class="col-md-12">
                                        <input id="Subject" class="Subject" type="text" name="a_qualify4" placeholder="Acedemic Qualifications 4 / අධ්‍යාපනික සුදුසුකම් 1">
                                    </div>
