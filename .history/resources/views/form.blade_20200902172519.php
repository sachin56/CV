                        ...
                        <div class="row">
                            ...
                            <div class="col-md-10 center-form border-box" style="margin-top: 20px;padding-bottom: 100px;">
                                <form method="post" class="contact-form" id="FormOne" enctype="multipart/form-data">
                                    ...
                                    <div class="col-md-6">
                                        <input id="Results" class="Results" type="text" name="results7" placeholder="Results/ ප්‍රතිඵලය 3">
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <input id="Results" class="Results" type="text" name="results8" placeholder="Results/ ප්‍රතිඵලය 4">
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <input id="Results" class="Results" type="text" name="results9" placeholder="Results/ ප්‍රතිඵලය 5">
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <input id="al_results1" class="Results" type="text" name="al_results1" placeholder="Results/ ප්‍රතිඵලය 6" >
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <input id="al_results2" class="Results" type="text" name="al_results2" placeholder="Results/ ප්‍රතිඵලය 7">
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <input id="Results" class="Results" type="text" name="al_results3" placeholder="Results/ ප්‍රතිඵලය 8">
                                    </div>
