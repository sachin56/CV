                            ...
                            <div class="col-md-10 center-form border-box" style="margin-top: 20px;padding-bottom: 100px;">
                                <form method="post" class="contact-form" id="FormOne" enctype="multipart/form-data">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="col-md-6">
                                            <input id="Subject" class="Subject" type="text" name="non_refree2_name" placeholder="Referee2 Name /නිර්දේශ කරන්නාගේ නම 1" >
                                        </div>

                                        <div class="col-md-6">
                                            <input id="Subject" class="Subject" type="text" name="non_refree2_post" placeholder="Referee2 Post /නිර්දේශ කරන්නාගේ තනතුර 1" >
                                        </div>

                                        <div class="col-md-6">
                                            <input id="Subject" class="Subject" type="text" name="non_refree2_workplace" placeholder="Referee2 Workplace /නිර්දේශ කරන්නාගේ රැකියා ස්ථානය 1" >
                                        </div>

                                        <div class="col-md-6">
                                            <input id="Subject" class="Subject" type="text" name="non_refree2_tel" placeholder="Contact Number of Referee2 /නිර්දේශ කරන්නාගේ දුරකථන අංකය 1">
                                        </div>
