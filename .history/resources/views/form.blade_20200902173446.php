                        ...
                        <div class="row">
                            ...
                            <div class="col-md-10 center-form border-box" style="margin-top: 20px;padding-bottom: 100px;">
                                <form method="post" class="contact-form" id="FormOne" enctype="multipart/form-data">
                                    ...
                                    <div class="col-md-6">
                                        <input id="al_subject1" class="Subject" type="text" name="al_subject1" placeholder="Subject / විෂය 9" >
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <input id="al_subject2" class="Subject" type="text" name="al_subject2" placeholder="Subject / විෂය 9">
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <input id="Subject" class="Subject" type="text" name="al_subject3" placeholder="Subject / විෂය 9">
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <input id="Subject" class="Subject" type="text" name="al_subject4" placeholder="Subject / විෂය 9">
                                    </div>
