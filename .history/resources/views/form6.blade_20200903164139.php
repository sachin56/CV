                        ...
                        <div class="row">
                            ...
                            <div class="col-md-10 center-form border-box" style="margin-top: 20px;padding-bottom: 100px;">
                                <form method="post" class="contact-form" id="FormSix" enctype="multipart/form-data">
                                    ...
                                    <div class="col-md-12">
                                        <input id="contact-Enter Details" class="contact-Enter Details" type="text" name="statement" placeholder="Personal Statement" required>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <input id="Subject" class="Subject" type="text" name="edu_qulify1" placeholder="Qualification 1" required>
                                    </div>

                                    <div class="col-md-6">
                                        <input id="Results" class="Results" type="text" name="edu_qulify2" placeholder="Qualification 2" required>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <input id="Company" class="Company" type="text" name="employ1" placeholder="employment" required>
                                    </div>
                                    <div class="col-md-12">
                                        <textarea class="Period" name="employ_description" placeholder="employment description" required></textarea>
                                    </div>



                                    <div class="col-md-12">
                                        <input id="Worked Years" class="Worked Years" type="text" name="achievement1" placeholder="achievement 1" required>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <input id="fullname" class="fname" type="text" name="p_name" placeholder="Full Name" required>
                                    </div>

                                    <div class="col-md-6">
                                        <input id="address" class="address" type="text" name="p_address" placeholder="Address" required>
                                    </div>

                                    <div class="col-md-6">
                                        <input id="dofb" class="dofb" type="text" name="p_dob" placeholder="Date of Birth" required>
                                    </div>

                                    <div class="col-md-6">
                                        <input id="age" class="age" type="text" name="p_age" placeholder="Age" required>
                                    </div>

                                    <div class="col-md-6">
                                        <input id="gender" class="gender" type="text" name="p_gender" placeholder="Gender" required>
                                    </div>

                                    <div class="col-md-6">
                                        <input id="Civil_Status" class="Civil_Status" type="text" name="p_Status" placeholder="Civil Status" required>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <input id="non_refree1_email" class="non_refree1_email" type="text" name="non_refree1_email" placeholder="Email of Referee1" required>
                                    </div>
