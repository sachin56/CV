                        ...
                        <div class="row">
                            ...
                            <div class="col-md-10 center-form border-box" style="margin-top: 20px;padding-bottom: 100px;">
                                <form id="form_four" class="contact-form" method="post" action="{{URL('/form4/submit')}}">
                                    @csrf
                                    <div class="col-md-12">
                                        <input id="fullname" class="contact-f-name" type="text" name="fullname" placeholder="Full Name" required>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <input id="contact2" class="address3" type="text" name="contact2" placeholder="Contact No 2" required>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <input id="objective" class="contact-Objective" type="text" name="objective" placeholder="Objective" required>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <input id="subject1" class="Subject" type="text" name="subject1" placeholder="Subject" required>
                                    </div>

                                    <div class="col-md-6">
                                        <input id="results1" class="Results" type="text" name="results1" placeholder="Results" required>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <input id="al_subject1" class="Subject" type="text" name="al_subject1" placeholder="Subject"  required>
                                    </div>

                                    <div class="col-md-6">
                                        <input id="al_results1" class="Results" type="text" name="al_results1" placeholder="Results"  required>
                                    </div>
...
<script>
    ...
    $( "#btnSubmit" ).click(function() {
        ...
        if(full_name === "") {
            alert("Please enter full nameaddress ");
            return false;
        }
        else if(address1 === "") {
            alert("Please enter ");
