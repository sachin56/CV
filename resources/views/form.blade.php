                        ...
                        <div class="row">
                            ...
                            <div class="col-md-10 center-form border-box" style="margin-top: 20px;padding-bottom: 100px;">
                                <form method="post" class="contact-form" id="FormOne" enctype="multipart/form-data">
                                    ...
                                    <div class="col-md-6">
                                        <input id="subject1" class="Subject" type="text" name="subject1" placeholder="Subject / විෂය 1" >
                                    </div>

                                    <div class="col-md-6">
                                        <input id="results1" class="Results" type="text" name="results1" placeholder="Results / ප්‍රතිඵලය 1" >
                                    </div>

                                    <div class="col-md-6">
                                        <input id="subject2" class="Subject" type="text" name="subject2" placeholder="Subject / විෂය 2">
                                    </div>

                                    <div class="col-md-6">
                                        <input id="results2" class="Results" type="text" name="results2" placeholder="Results / ප්‍රතිඵලය 2">
                                    </div>

                                    <div class="col-md-6">
                                        <input id="subject3" class="Subject" type="text" name="subject3" placeholder="Subject / විෂය 3">
                                    </div>

                                    <div class="col-md-6">
                                        <input id="results3" class="Results" type="text" name="results3" placeholder="Results / ප්‍රතිඵලය 3">
                                    </div>

                                    <div class="col-md-6">
                                        <input id="Subject" class="Subject" type="text" name="subject4" placeholder="Subject / විෂය 4">
                                    </div>

                                    <div class="col-md-6">
                                        <input id="Results" class="Results" type="text" name="results4" placeholder="Results / ප්‍රතිඵලය 4">
                                    </div>

                                    <div class="col-md-6">
                                        <input id="Subject" class="Subject" type="text" name="subject5" placeholder="Subject / විෂය 5">
                                    </div>

                                    <div class="col-md-6">
                                        <input id="Results" class="Results" type="text" name="results5" placeholder="Results / ප්‍රතිඵලය 5">
                                    </div>

                                    <div class="col-md-6">
                                        <input id="Subject" class="Subject" type="text" name="subject6" placeholder="Subject / විෂය 6">
                                    </div>

                                    <div class="col-md-6">
                                        <input id="Results" class="Results" type="text" name="results6" placeholder="Results / ප්‍රතිඵලය 6">
                                    </div>

                                    <div class="col-md-6">
                                        <input id="Subject" class="Subject" type="text" name="subject7" placeholder="Subject / විෂය 7">
                                    </div>

                                    <div class="col-md-6">
                                        <input id="Results" class="Results" type="text" name="results7" placeholder="Results / ප්‍රතිඵලය 7">
                                    </div>

                                    <div class="col-md-6">
                                        <input id="Subject" class="Subject" type="text" name="subject8" placeholder="Subject / විෂය 8">
                                    </div>

                                    <div class="col-md-6">
                                        <input id="Results" class="Results" type="text" name="results8" placeholder="Results / ප්‍රතිඵලය 9">
                                    </div>

                                    <div class="col-md-6">
                                        <input id="Subject" class="Subject" type="text" name="subject9" placeholder="Subject / විෂය 9">
                                    </div>

                                    <div class="col-md-6">
                                        <input id="Results" class="Results" type="text" name="results9" placeholder="Results / ප්‍රතිඵලය 9">
                                    </div>

                                    <div class="col-md-12"><h4>G.C.E.(A/L) Examination / උසස් පෙල ප්‍රතිඵල</h4></div>
                                    <div class="col-md-6">
                                        <input id="al_subject1" class="Subject" type="text" name="al_subject1" placeholder="Subject / විෂය 1" >
                                    </div>

                                    <div class="col-md-6">
                                        <input id="al_results1" class="Results" type="text" name="al_results1" placeholder="Results / ප්‍රතිඵලය 1" >
                                    </div>

                                    <div class="col-md-6">
                                        <input id="al_subject2" class="Subject" type="text" name="al_subject2" placeholder="Subject / විෂය 2">
                                    </div>

                                    <div class="col-md-6">
                                        <input id="al_results2" class="Results" type="text" name="al_results2" placeholder="Results / ප්‍රතිඵලය 2">
                                    </div>

                                    <div class="col-md-6">
                                        <input id="Subject" class="Subject" type="text" name="al_subject3" placeholder="Subject / විෂය 3">
                                    </div>

                                    <div class="col-md-6">
                                        <input id="Results" class="Results" type="text" name="al_results3" placeholder="Results / ප්‍රතිඵලය 3">
                                    </div>

                                    <div class="col-md-6">
                                        <input id="Subject" class="Subject" type="text" name="al_subject4" placeholder="Subject / විෂය 4">
                                    </div>

                                    <div class="col-md-6">
                                        <input id="Results" class="Results" type="text" name="al_results4" placeholder="Results / ප්‍රතිඵලය 4">
                                    </div>

                                    <div class="col-md-12">
                                        <h4>Other Qualifications / අනෙකුත් සුදුසුකම්</h4>
                                    </div>

                                    <div class="col-md-12">
                                        <textarea name="other_qualify" id="other_qualify" class="contact-Enter Details" type="text" placeholder="Enter Other qualification details / අනෙකුත් සුදුසුකම්" ></textarea>
                                    </div>

                                    <div class="col-md-12">
                                        <h4>ACEDEMIC QUALIFICATIONS / අධ්‍යාපනික සුදුසුකම්</h4>
                                    </div>

                                    <div class="col-md-12">
                                        <input id="a_qualify1" class="Subject" type="text" name="a_qualify1" placeholder="Acedemic Qualifications 1 / අධ්‍යාපනික සුදුසුකම් 1" >
                                    </div>

                                    <div class="col-md-12">
                                        <input id="Subject" class="Subject" type="text" name="a_qualify2" placeholder="Acedemic Qualifications 2 / අධ්‍යාපනික සුදුසුකම් 2">
                                    </div>

                                    <div class="col-md-12">
                                        <input id="Subject" class="Subject" type="text" name="a_qualify3" placeholder="Acedemic Qualifications 3 / අධ්‍යාපනික සුදුසුකම් 3">
                                    </div>

                                    <div class="col-md-12">
                                        <input id="Subject" class="Subject" type="text" name="a_qualify4" placeholder="Acedemic Qualifications 4 / අධ්‍යාපනික සුදුසුකම් 4">
                                    </div>

                                    <div class="col-md-12">
                                        <h4>PROFESSIONAL QUALIFICATION / වෘත්තීය සුදුසුකම්</h4>
                                    </div>

                                    <div class="col-md-12">
                                        <input id="p_qualify1" class="Subject" type="text" name="p_qualify1" placeholder="Professional Qualification 1 / වෘත්තීය සුදුසුකම් 1" >
                                    </div>

                                    <div class="col-md-12">
                                        <input id="Subject" class="Subject" type="text" name="p_qualify2" placeholder="Professional Qualification 2 / වෘත්තීය සුදුසුකම් 2" >
                                    </div>

                                    <div class="col-md-12">
                                        <input id="Subject" class="Subject" type="text" name="p_qualify3" placeholder="Professional Qualification 3 / වෘත්තීය සුදුසුකම් 3" >
                                    </div>

                                    <div class="col-md-12">
                                        <input id="Subject" class="Subject" type="text" name="p_qualify4" placeholder="Professional Qualification 4 / වෘත්තීය සුදුසුකම් 4">
                                    </div>

                                    <div class="col-md-12">
                                        <div class="col-md-12">
                                            <h4>SKILLS AND COMPETENCIES / දක්ශතා හා කුසලතා </h4>
                                        </div>

                                        <div class="col-md-12">
                                            <input id="skill1" class="Subject" type="text" name="skill1" placeholder="Skills And Competencies 1 / දක්ශතා හා කුසලතා 1" >
                                        </div>

                                        <div class="col-md-12">
                                            <input id="Subject" class="Subject" type="text" name="skill2" placeholder="Skills And Competencies 2 / දක්ශතා හා කුසලතා 2" >
                                        </div>

                                        <div class="col-md-12">
                                            <input id="Subject" class="Subject" type="text" name="skill3" placeholder="Skills And Competencies 3 / දක්ශතා හා කුසලතා 3" >
                                        </div>

                                        <div class="col-md-12">
                                            <input id="Subject" class="Subject" type="text" name="skill4" placeholder="Skills And Competencies 4 / දක්ශතා හා කුසලතා 4" >
                                        </div>

                                        <div class="col-md-12">
                                            <input id="Subject" class="Subject" type="text" name="skill5" placeholder="Skills And Competencies 5 / දක්ශතා හා කුසලතා 5" >
                                        </div>

                                        <div class="col-md-12">
                                            <input id="Subject" class="Subject" type="text" name="skill6" placeholder="Skills And Competencies 6 / දක්ශතා හා කුසලතා 6">
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <input id="non_refree1_name" class="Subject" type="text" name="non_refree1_name" placeholder="Referee1 Name /නිර්දේශ කරන්නාගේ නම 1" >
                                        </div>

                                        <div class="col-md-6">
                                            <input id="non_refree1_post" class="Subject" type="text" name="non_refree1_post" placeholder="Referee1 Post /නිර්දේශ කරන්නාගේ තනතුර 1 " >
                                        </div>

                                        <div class="col-md-6">
                                            <input id="non_refree1_workplace" class="Subject" type="text" name="non_refree1_workplace" placeholder="Referee1 Workplace /නිර්දේශ කරන්නාගේ රැකියා ස්ථානය 1" >
                                        </div>

                                        <div class="col-md-6">
                                            <input id="non_refree1_tel" class="Subject" type="text" name="non_refree1_tel" placeholder="Contact Number of Referee1 /නිර්දේශ කරන්නාගේ දුරකථන අංකය 1" >
                                        </div>

                                        <div class="col-md-6">
                                            <input id="Subject" class="Subject" type="text" name="non_refree2_name" placeholder="Referee2 Name /නිර්දේශ කරන්නාගේ නම 2" >
                                        </div>

                                        <div class="col-md-6">
                                            <input id="Subject" class="Subject" type="text" name="non_refree2_post" placeholder="Referee2 Post /නිර්දේශ කරන්නාගේ තනතුර 2" >
                                        </div>

                                        <div class="col-md-6">
                                            <input id="Subject" class="Subject" type="text" name="non_refree2_workplace" placeholder="Referee2 Workplace /නිර්දේශ කරන්නාගේ රැකියා ස්ථානය 2" >
                                        </div>

                                        <div class="col-md-6">
                                            <input id="Subject" class="Subject" type="text" name="non_refree2_tel" placeholder="Contact Number of Referee2 /නිර්දේශ කරන්නාගේ දුරකථන අංකය 2">
                                        </div>
